...
public final class DrawingPanel extends JPanel {
    ...
    /**
     * This will initializes the fields and mouse listeners
     * to the panel.
     */
    public DrawingPanel() {
    ...
    /**
     *This will set the current color.
     * 
    ...
    /**
     * This will set the current thickness.
     * 
    ...
    /**
     * This will set the current tool.
     * 
    ...
    /**
     * This will set the current cap style.
     * 
    ...
    /**
     * This will set the current join style. 
     * 
    ...
    /**
     * This will return the current thickness.
     * 
    ...
    /**
     * This will clear the drawing panel.
     */
    ...
    /**
     * This will add a listener for the property change events.
     * 
    ...
    /**
     * This will Remove a listener for the property change events.
     * 
    ...
    /**
     * This will listen for mouse events to draw on the panel.
     */
    ...
    /**
     * This will listen for mouse motion events to draw on the panel.
     */
